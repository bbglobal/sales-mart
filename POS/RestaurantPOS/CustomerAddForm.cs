...
namespace POS
{
    public partial class CustomerAddForm : Form
    {
        ...
        public CustomerAddForm(int rowIndex = -1)
        {
            InitializeComponent();
        ...
        private void SaveData()
        {
            ...
            try
            {
                ...
                // Insert query for the customers table
                string query = "INSERT INTO customers (customer_name, phone_number, email, address, credit, points) " +
                               "VALUES (@CustomerName, @Phone, @Email, @Address, @Credit, @Points)";
