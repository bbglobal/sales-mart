...
namespace POS
{
    public partial class CustomerUpdateForm : Form
    {
        ...
        public CustomerUpdateForm(int rowIndex = -1)
        {
            InitializeComponent();
        ...
        public CustomerUpdateForm(string customerId, string customerName, string phoneNumber, string email, string address, DateTime lastPurchaseDate, string credit, string points, int rowIndex)
        {
            InitializeComponent();
        ...
        private void InitializeDatabaseConnectionOLD()
        {
            string connectionString = ConfigurationManager.ConnectionStrings["myconn"]?.ConnectionString;
