...
namespace POS
{
    public partial class Dashboard : Form
    {
        ...
        private int panel1targetWidth;
        private int initialWidth;
        private int panel1initialWidth;
        ...
        private void StartTransition(int newWidth)
        {
            ...
            panel1initialWidth = panel4.Width;
            panel1targetWidth = newWidth;
        ...
        private void LabelTimer_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //int newY = (int)(initialPosition.Y + (targetPosition.Y - initialPosition.Y) * progress);
        ...
        private void PanelTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (progress1 >= 1.0)
            {
                ...
                panel2.Width = panel1initialWidth + (initialWidth);
            }
            else
            {
